...
public class Worker {
    ...
    public static void main(String[] args) {
        ...
        String currentWorkerHost = "127.0.0.1"; 
        ...
        try {
            Socket reducerSocket = new Socket("127.0.0.1", 6000);
            System.out.println("Connected to Reducer at 127.0.0.1:6000");
            ...
            System.out.println("Could not connect to Reducer at 127.0.0.1:6000");
            e.printStackTrace();
        }
    }
}
